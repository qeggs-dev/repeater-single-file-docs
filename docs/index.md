...
{{merge_text("./prompt/repeater.md")}}

{{merge_text("./prompt/night-light.md")}}

{{merge_text("./prompt/laurel.md")}}
...
{{merge_text("./prompt/inverted-repeater.md")}}

{{merge_text("./prompt/inverted-night-light.md")}}

{{merge_text("./prompt/inverted-laurel.md")}}
...
{{merge_text("./prompt/inverted-repeater-old.md")}}

{{merge_text("./prompt/inverted-night-light-old.md")}}

{{merge_text("./prompt/inverted-laurel-old.md")}}
...
{{ merge_text("./prompt/legacy-first-glance.md") }}

{{ merge_text("./prompt/legacy-test-run.md") }}

{{ merge_text("./prompt/legacy-blossoming.md") }}

{{ merge_text("./prompt/legacy-secret-diary.md") }}

{{ merge_text("./prompt/legacy-coming-of-age.md") }}
